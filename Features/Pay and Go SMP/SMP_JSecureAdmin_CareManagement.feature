Feature: SMP jSecure Care Management  Add
  @Web
  Scenario Outline:
  This test Sceanrio is ensure that SMP user is able to Add Groups
    ...
    Examples:
      ...
      |TB                                                 |Username|Password |Service Provider Access|
      |http://sntb1-ppsmpw-11:8080/smp_jsecure/jsp/login.jsp |Admin   |SW50ZXJhY3Q=|O2 Online           |
